package LinkedListAlgo.singlylinkedlist;

import LinkedListAlgo.singlylinkedlist.operations.DeletingInLinkedList;
import LinkedListAlgo.singlylinkedlist.operations.Node;
import LinkedListAlgo.singlylinkedlist.operations.PrintLinkedList;
...
public class DriverProgram {
    ...
    public static void main(String[] args) {
        ...
        // 1.Inserting data into linked list
        ...
        //    // 3.Creating a loop for testing
        //    head.next.next.next.next.next = head.next.next;
        //
        //    //4.Detecting and removing loop 1st Approach
